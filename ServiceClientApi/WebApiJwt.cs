...
{
    public class WebApiJwt : Notifiable
    {
        ...
        public WebApiJwt(string keyJwt, KeyTypeJwt keyType = KeyTypeJwt.Bearer)
        {
            _keyJwt = keyJwt;
            _keyType = keyType;
        }

        public WebApiJwt(string keyJwt, KeyTypeJwt keyType, string keyScheme = "")
        {
            _keyJwt = keyJwt;
            _keyType = keyType;
        ...
        public WebApiJwt(string keyJwt, string uriWebApi, KeyTypeJwt tipoChave = KeyTypeJwt.Bearer)
        {
            _keyJwt = keyJwt;
        ...
        public T1 Delete<T1, T2>(T2 sendObject = default(T2), string route = "") where T1 : new() where T2 : new()
        {
            ...
            try
            {
                retorno = _returnResult<T1, T2>(sendObject, HttpMethod.Delete
, route);
            }
            catch (Exception ex)
            {
